...
<template>
    ...
    <div class="min-h-screen bg-gray-50 font-sans text-gray-900 flex flex-col">
        ...
        <div class="bg-[#1D2A68] py-20 border-b-4 border-[#F4B223]">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <span class="text-[#F4B223] font-bold tracking-wider uppercase text-sm mb-4 block">Economic Hub of the South</span>
                <h1 class="text-4xl font-extrabold text-white sm:text-5xl tracking-tight mb-6">Key Economic Sectors</h1>
                <p class="max-w-3xl mx-auto text-xl text-blue-200">
