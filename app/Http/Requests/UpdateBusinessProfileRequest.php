...
class UpdateBusinessProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'tpin' => ['required', 'regex:/^\d{10}$/', 'unique:business_profiles,tpin,' . $profileId],
            'pacra_reg_no' => 'required_unless:member_type,Associate|nullable|string|max:50|unique:business_profiles,pacra_reg_no,' . $profileId,
    ...
    public function messages(): array
    {
        return [
            ...
            'phone.regex' => 'Phone number must be a valid Zambian number (+260..., 260..., or 09...).',
            ...
            'proof_of_payment.mimes' => 'Proof of payment must be a PDF, JPG, or PNG file.',
            'proof_of_payment.max' => 'Proof of payment file size cannot exceed 5MB.',
        ];
    }
